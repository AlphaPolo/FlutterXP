...
class PainterRectangle extends PainterPaintContent {
  PainterRectangle();

  PainterRectangle.data({
  ...
  factory PainterRectangle.fromJson(Map<String, dynamic> data) {
    return PainterRectangle.data(
  ...
  @override
  PainterRectangle copy() => PainterRectangle();
