    ...
    Widget buildSelection(MenuEntry selection) {
      ...
      if (selection.menuChildren != null) {
        ...
        return SubmenuButton(
          menuStyle: MenuStyle(
            padding: const MaterialStatePropertyAll<EdgeInsets>(EdgeInsets.all(2)),
            side: const MaterialStatePropertyAll<BorderSide>(BorderSide(width: 1, color: Colors.grey)),
            backgroundColor: const MaterialStatePropertyAll<Color>(Colors.white),
            shape: menuBarThemeData.style?.shape,
          ),
          menuChildren: MenuEntry.build(selection.menuChildren!),
          leadingIcon: selection.isChecked ? const Icon(Icons.check, size: 12) : null,
